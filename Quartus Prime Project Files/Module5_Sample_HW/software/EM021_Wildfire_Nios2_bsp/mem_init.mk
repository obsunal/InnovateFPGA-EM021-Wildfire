...
# Memory: nios_system_onchip_memory2
MEM_0 := top_qsys_nios_system_onchip_memory2
$(MEM_0)_NAME := nios_system_onchip_memory2
...
$(MEM_0)_HIERARCHICAL_PATH := nios_system.onchip_memory2
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: nios_system_onchip_memory2
nios_system_onchip_memory2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: nios_system_shared_memory
MEM_1 := top_qsys_nios_system_shared_memory
$(MEM_1)_NAME := nios_system_shared_memory
...
$(MEM_1)_END := 0x00002fff
$(MEM_1)_SPAN := 0x00001000
$(MEM_1)_HIERARCHICAL_PATH := nios_system.shared_memory
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: nios_system_shared_memory
nios_system_shared_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
