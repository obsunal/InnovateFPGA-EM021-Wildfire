...
SOPCINFO_FILE := d:/HW/InnovateFPGA/Module5_Sample_HW/top_qsys.sopcinfo
...
# CPU Name 
# setting CPU_NAME is nios_system_nios2_gen2
CPU_NAME = nios_system_nios2_gen2
...
# The SOPC System ID 
# setting SOPC_SYSID is 305419896
SOPC_SYSID_FLAG += --id=305419896
ELF_PATCH_FLAG  += --id 305419896

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x410b0
SOPC_SYSID_FLAG += --sidp=0x410b0
ELF_PATCH_FLAG  += --sidp 0x410b0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1650142042
SOPC_SYSID_FLAG += --timestamp=1650142042
ELF_PATCH_FLAG  += --timestamp 1650142042
...
# setting hal.stderr is nios_system_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev nios_system_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is nios_system_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev nios_system_jtag_uart
...
# setting hal.stdout is nios_system_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev nios_system_jtag_uart
